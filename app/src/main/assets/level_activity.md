...
| 레벨 | 색상명    | HEX       | 설명           |
| -- | ------ | --------- | ------------ |
| 1  | 연한 하늘색 | `#4FC3F7` | 시작, 가벼움, 상쾌함 |
| 2  | 청록색    | `#00ACC1` | 안정감, 집중 시작   |
| 3  | 연두색    | `#81C784` | 성취감의 첫 단계    |
| 4  | 밝은 초록  | `#43A047` | 꾸준함, 성장      |
| 5  | 노랑     | `#FDD835` | 눈에 띔, 중간 성취  |
| 6  | 주황     | `#FB8C00` | 에너지, 강한 의지   |
| 7  | 빨강     | `#E53935` | 열정, 최상위 근접   |
| 8  | 보라     | `#8E24AA` | 왕관, 최종 레벨 상징 |
