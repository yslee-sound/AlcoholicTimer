# [OBSOLETE] 업데이트 UI 통합 가이드(데모 모드, 금주 설정 화면 롱프레스 트리거)

> **⚠️ 이 문서는 더 이상 유효하지 않습니다.**
> 
> - 상태: OBSOLETE (2025-11-04)
> - 사유: 금주 시작 화면의 '목표 기간 설정' 롱프레스 업데이트 팝업 데모 기능이 삭제됨
> - 대체: 설정 > 디버그 모드에서 별도의 업데이트 팝업 테스트 기능 사용
> - 실제 In-App Update는 AppUpdateManager와 AppUpdateDialog를 통해 자동으로 처리됨
